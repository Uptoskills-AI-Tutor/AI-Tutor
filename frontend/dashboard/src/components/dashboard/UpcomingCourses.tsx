...
const UpcomingCourses: React.FC<UpcomingCoursesProps> = ({ courses }) => {
  return (
    <div className="card h-full">
      ...
      <div className="space-y-4">
        {courses.map((course) => (
          <div key={course.id} className="flex items-start gap-4 border-b border-gray-100 pb-4 last:border-0">
