      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 bg-blue-50 hover-blue-100 px-4 py-2 rounded-md transition-colors duration-200"
          >
            {selectedSubject}
            <ChevronDown size={16} />
          </button>
            ...
            <div className="absolute top-full left-0 mt-1 bg-white shadow-lg rounded-md py-2 w-64 z-20 animate-slide-in">
              {availableSubjects.map((subject) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2 hover-gray-100 ${
