    ...
    <div className="card h-full">
      ...
      <div className="space-y-4">
        {quizzes.slice(0, 3).map((quiz) => (
          <div key={quiz.id} className="p-3 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors">
            <div className="flex items-center gap-4">
              ...
              <div className={`text-sm font-medium px-2 py-1 rounded ${
                quiz.score >= 90 ? 'bg-success-100 text-success-800' :
                quiz.score >= 70 ? 'bg-primary-100 text-primary-800' :
